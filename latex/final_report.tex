...
Because the Viterbi decoder output did not show the frame counter, we use only MATLAB generated data to test the functionality of our Reed Solomon decoder.
