...
In the input data, we observe our transmitted message and the parity bits (noisy spikes). Because there are no errors in our transmitted message, the Reed Solomon decoder output is simply the first 223 bytes in the received data. We can also experiment with the error correction capabilities by inserting random errors into our input data.
