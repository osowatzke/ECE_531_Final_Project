...
class rs_test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_stream_to_vector_1 = blocks.stream_to_vector(gr.sizeof_char*1, 255)
        self.blocks_pack_k_bits_bb_0_0 = blocks.pack_k_bits_bb(8)
        self.blocks_file_source_1 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/sdr/repos/ECE_531_Final_Project/code/data_mod.dat', False, 0, 4096)
