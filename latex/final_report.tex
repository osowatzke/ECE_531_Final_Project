...
To familiarize ourselves with the Reed Solomon Decoder, we instantiate a Reed Solomon Decoder in GNU radio and test it on MATLAB-generated data with and without errors. Our flowchart is shown in Figure \ref{fig::rs_test_grc}. 
